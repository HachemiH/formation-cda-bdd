...
#### 4.2.1.5 Explication de l'Opérateur LIKE et du Symbole %
...
#### 4.2.1.6 Autres Utilisations Avancées
...
- Cela garantit que si des clients d'une même ville ont le même nom de ville, le critère suivant (l'âge, dans ce cas) sera utilisé pour ordonner ces enregistrements spécifiques.
