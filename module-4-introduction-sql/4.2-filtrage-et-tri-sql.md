...
1. Sélectionner toutes les commandes avec un prix unitaire supérieur à 20 €.
2. Sélectionner les commandes de la catégorie 'Mobilier', triées par prix unitaire de manière descendante.
3. Sélectionner toutes les commandes livrées à 'Paris' qui ne sont pas de la catégorie 'Électronique'.
4. Sélectionner les commandes passées entre le 1er avril 2023 et le 30 juin 2023.
5. Sélectionner les noms des clients et les produits commandés, pour les commandes contenant des produits dont le nom commence par 'C'.
6. Sélectionner les commandes dont la quantité est supérieure à 1, triées par date de commande de manière ascendante.
7. Sélectionner toutes les commandes de 'Marc' ou 'Julie', excluant celles livrées à 'Nantes'.
8. Sélectionner les commandes dont le produit est soit une 'Table', soit un 'Bureau'.
