...
<details open>
<summary>1. Appliquer les principes de la 2NF à la table "CoursUniversitaires" (<a href="https://github.com/HachemiH/formation-cda-bdd/tree/TPC-3.9.2.1">voir la solution</a>)</summary>
<br/>

| ID_Cours | Département   | Nom_Cours     | Enseignant  |
| -------- | ------------- | ------------- | ----------- |
| 101      | Informatique  | Programmation | M. Dupont   |
| 102      | Mathématiques | Algèbre       | Mme. Durand |
