...
- **Accès à `psql`** : Démarrage de l'interface `psql` en tapant `psql` dans le terminal; vérification de la configuration du chemin d'accès dans les variables d'environnement.
